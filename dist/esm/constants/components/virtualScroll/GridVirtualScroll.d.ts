...
declare const _default: <LIST extends UnknownArrayType>({ list, className, scrollTarget, preloadRowCnt, itemWidth, itemHeight, gapX, gapY, loading, loadingElement, skeletonElement, skeletonCnt, noDataMsg, element }: Props<LIST>) => React.JSX.Element;
