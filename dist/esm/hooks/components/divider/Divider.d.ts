 ...
 * @returns 구분선 컴포넌트
 */
declare const Divider: ({ className, type, variant, color, size, spaceSize, spaceDirection, contentAlign, contentSpace, contentPosition, children, style }: Props) => React.JSX.Element;
