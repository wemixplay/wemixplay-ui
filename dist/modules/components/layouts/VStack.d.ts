 ...
 * @returns 수직 스택 컴포넌트
 */
declare const VStack: ({ id, className, inline, justifyContent, justifyItems, justifySelf, alignItems, alignSelf, alignContent, gap, columnGap, rowGap, style, children, tag, ...rest }: PropsType) => React.DetailedReactHTMLElement<{
    id: string;
    className: string;
    style: {
